...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp Ken ID
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo 
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig iamshadam_
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & 
➸ *${prefix}ytmp3*
...
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub   & Hub
